...
//		}
    ...
    public User[] doListUsersWithID(String filter, int maxItemLimit) throws UserStoreException {
        ...
        try {
            ...
            //TODO: change the query to get the userID from username search
            if (isCaseSensitiveUsername()) {
                sqlStmt = realmConfig.getUserStoreProperty(JDBCRealmConstants.GET_USER_FILTER);
            } else {
                sqlStmt = realmConfig.getUserStoreProperty(JDBCCaseInsensitiveConstants.GET_USER_FILTER_CASE_INSENSITIVE);
...
//    public User doAuthenticate(String preferredUserNameProperty, String preferredUserNameValue, Object credential,
//            String profileName) throws UserStoreException {
//        if(true) {
//
//        } else {
//            doAuthenticate(preferredUserNameValue, credential);
//        }
//    }
    ...
    public void doDeleteUser(String userName) throws UserStoreException {
        ...
        if (UserCoreUtil.isUniqueUserIDFeatureEnabled()) {
            doDeleteUserInternal(getUserID(UserCoreClaimConstants.USERNAME_CLAIM_URI, userName, null));
        } else {
    ...
    public void doSetUserClaimValue(String userName, String claimURI, String claimValue, String profileName)
        ...
        if (UserCoreUtil.isUniqueUserIDFeatureEnabled()) {
            doSetUserClaimValueInternal(getUserID(UserCoreClaimConstants.USERNAME_CLAIM_URI, userName, profileName),
    ...
    public void doSetUserClaimValues(String userName, Map<String, String> claims, String profileName)
        ...
        if (UserCoreUtil.isUniqueUserIDFeatureEnabled()) {
            doSetUserClaimValuesInternal(getUserID(UserCoreClaimConstants.USERNAME_CLAIM_URI, userName, profileName),
                    claims, profileName);
        } else {
